...
const LeaveSheet = () => {
 ...
 const fetchLeaveSheet =  async () => {
  try{
    ...
    const response = await axios.get("https://middlewaretalentsbackend.azurewebsites.net/api/getSheets", {
        method:'GET',
        headers:{
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(isSubmitted && leaveId){
        const response =  await axios.put(`https://middlewaretalentsbackend.azurewebsites.net/api/updateSheet/${leaveId}`, leaveData, {
