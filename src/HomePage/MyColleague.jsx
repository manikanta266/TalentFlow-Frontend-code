...
export default function MyColleague() {
    ...
    useEffect(() => {
        ...
        if (!email || !role) {
            ...
            navigate('/login');
        } else if (managerId) { // Check if managerId is defined before calling fetchEmployees
            fetchEmployees();
        } else {
    ...
    return (
        <div className="min-h-screen bg-gray-100 w-full">
            <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-8">My Colleagues</h1>
