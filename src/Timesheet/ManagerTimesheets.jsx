                    ...
                    {currentEmployees.map((submission) => (
                      <tr key={submission.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                             {submission.status === "APPROVED" && <FaCheckCircle className="mr-2" />}
                             {submission.status === "REJECTED" && <FaTimesCircle className="mr-2" />}
                             {submission.status === "PENDING" && <FaHourglassHalf className="mr-2" />}
                            {submission.status}
                          </span>
                        </td>
