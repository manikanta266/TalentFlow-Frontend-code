...
export default function LeaveApprovalDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://msquirebackend.azurewebsites.net/api/leaves/manager/${managerId}`, {
          method:'GET',
          headers:{
  ...
  const handleReject = async () => {
    ...
    const token = localStorage.getItem('token')
      await axios.put(`https://msquirebackend.azurewebsites.net/api/leaves/reject/${selectedLeaveId}/${rejectionReason}`, null,  {
...
useEffect(() => {
  ...
  const renderActions = (data) => {
    ...
    console.log("data"+data);
      ...
      else if ((data.leaveStatus === 'APPROVED' || data.leaveStatus === 'REJECTED') && data.leaveType === 'SICK'){
